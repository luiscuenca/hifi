...
#ifndef hifi_AvatarJointMotionState_h
#define hifi_AvatarJointMotionState_h
...
class AvatarJointMotionState : public ObjectMotionState {
public:
    AvatarJointMotionState(AvatarSharedPointer avatar, int jointIndex, const btCollisionShape* shape);
...
#endif // hifi_AvatarJointMotionState_h
