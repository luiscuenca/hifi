...
public:
    ...
    * @param {Vec3Pair[]} lines - vector of vec3 pairs with start and end points for each line in world space.
    * @param {Vec4} color - color of line, each component should be in the zero to one range.  x = red, y = blue, z = green, w = alpha.
    * @param {Vec3} translation - global lines translation in world space.
    * @param {quat} rotation - global lines rotation in world space.
    */
