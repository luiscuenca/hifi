...
const uint16_t USER_COLLISION_GROUP_AVATARS = USER_COLLISION_GROUP_MY_AVATAR | USER_COLLISION_GROUP_OTHER_AVATAR;
...
const uint16_t USER_COLLISION_MASK_AVATARS = USER_COLLISION_GROUP_AVATARS;
