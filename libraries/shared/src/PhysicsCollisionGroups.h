...
const int16_t BULLET_COLLISION_GROUP_DETAILED = 1 << 5;
const int16_t BULLET_COLLISION_GROUP_DETAILED_RAY = 1 << 6;
// ...
...
const int16_t BULLET_COLLISION_MASK_DETAILED = BULLET_COLLISION_GROUP_DETAILED_RAY;
const int16_t BULLET_COLLISION_MASK_DETAILED_RAY = BULLET_COLLISION_GROUP_DETAILED;
